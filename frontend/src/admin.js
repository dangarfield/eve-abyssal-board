            ...
            <div class="row">
                <div class="col">
                    ...
                    <form class="admin-form">
                        ...
                        <div class="row mb-3">
                            <label for="listingPercentage" class="col-sm-2 col-form-label">Listing Percentage</label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="listingPercentage" value="${appConfig.listingPercentage}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="storefrontFee" class="col-sm-2 col-form-label">Storefront Fee</label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="storefrontFee" value="${appConfig.storefrontFee}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="premiumListing" class="col-sm-2 col-form-label">Premium Listing Fee</label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="premiumListing" value="${appConfig.premiumListing}">
                            </div>
                        </div>
                        <div class="row mb-3">
